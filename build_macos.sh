...
# The script is used to build libffi for macOS.
...
# macOS uses clang as the default C/C++ compiler
cmake ${LIBFFI_SRC_PATH} -DCMAKE_INSTALL_PREFIX=${OUTPUT_DIR} -DCMAKE_BUILD_TYPE=Release \
  -DCMAKE_C_COMPILER=clang -DCMAKE_CXX_COMPILER=clang++ \
  -DCMAKE_SYSTEM_NAME=Darwin # Specify macOS as the target platform
